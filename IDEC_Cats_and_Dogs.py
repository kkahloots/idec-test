...
if __name__ == "__main__":
    ...
    if args.dataset == 'mnist':  # recommends: n_clusters=2, update_interval=140
        x, y = load_mnist()
        optimizer = 'adam'
    elif args.dataset == 'usps':  # recommends: n_clusters=2, update_interval=30
    ...
    idec = IDEC(dims=[x.shape[-1], 250, 250, 500, 2], n_clusters=args.n_clusters, batch_size=args.batch_size)
